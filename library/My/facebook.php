 ...
 */
class My_FacebookApiException extends Exception
{
  /**
...
class My_Facebook
{
   ...
   * @throws My_FacebookApiException
   */
  protected function _restserver($params) {
    ...
    if (is_array($result) && isset($result['error_code'])) {
      throw new My_FacebookApiException($result);
    }
    return $result;
  }
  ...
  protected function _graph($path, $method='GET', $params=array()) {
    ...
    if (is_array($result) && isset($result['error'])) {
      $e = new My_FacebookApiException($result);
      switch ($e->getType()) {
        // OAuth 2.0 Draft 00 style
        case 'OAuthException':
        // OAuth 2.0 Draft 10 style
  ...
  protected function makeRequest($url, $params, $ch=null) {
    ...
    $result = curl_exec($ch);
    if ($result === false) {
      $e = new My_FacebookApiException(array(
